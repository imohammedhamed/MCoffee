  ...
  return (    
        <>
         <div className=' flex flex-row justify-between items-center'>
            ...
            <h2 className='text-6xl font-bold text-DarkBlue py-10'><span className='text-Blue600'>L</span>og In</h2>
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-2">
                ...
                <p className=' text-sm text-DarkBlue'>IF YOU {`DON'T`} HAVE AN ACCOUNT ? <Link href='/signup' className=' font-semibold text-Blue600 hover:underline'>SIGN UP</Link></p>
            </form>
            </Form>
            </div>
