...
export default function ErrorInTheShoppingCart({title,LinkTitle,Linkhref}:ErrorInTheShoppingCartProps) {
  return (
    <section className=' container mx-auto rounded-lg my-24 bg-white border border-solid border-lightBlue p-5 flex flex-col justify-center items-center'>
        <Image src={imgsrc} alt='user Cart is empty' className='py-10 rotate-90' width={250} height={250}/>
        <h1 className=' text-2xl text-Blue600'>{title}</h1>
