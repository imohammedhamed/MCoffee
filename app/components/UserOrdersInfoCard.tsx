    ...
    <section className=' lg:container lg:mx-auto'>
        <div className=' bg-Blue100 w-full p-5 lg:p-10 my-5 rounded-lg'>
                <div className=' flex flex-col justify-center items-center'>
                    ...
                    <h2 className=' text-4xl text-Red py-5'>{`!! Oops`}</h2>
                    <h3 className=' text-lg text-lightGrey'>{`i am soory but this just an MVP so  there isn't a  payment gateway integration yet so i cant craft this section`}</h3>
                    <p className=' text-base text-lightGrey '>{`But feel free to take a look at the case study I have added all the details there`}</p>
